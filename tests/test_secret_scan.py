...
class SecretScanTest(unittest.TestCase):
    ...
    def test_detects_extended_api_key_shape_without_echoing_value(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            sample = "sk-" + "example.with/slash+and=padding123456"
    ...
    def test_detects_untracked_nonignored_secret(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            sample = "sk-" + "untracked.with/slash+padding123456"
            (root / "pending.txt").write_text(f"api_key={sample}\n", encoding="utf-8")
    ...
    def test_does_not_follow_symlink_outside_root(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            sample = "sk-" + "outside.with/slash+padding123456"
