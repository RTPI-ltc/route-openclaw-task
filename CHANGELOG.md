...
- Renamed the GitHub repository to `Task-Compass-Skill` and the v0.3 release archives and plugin manifests to `task-compass`.
...
[Unreleased]: https://github.com/RTPI-ltc/Task-Compass-Skill/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/RTPI-ltc/Task-Compass-Skill/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/RTPI-ltc/Task-Compass-Skill/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/RTPI-ltc/Task-Compass-Skill/releases/tag/v0.1.0
